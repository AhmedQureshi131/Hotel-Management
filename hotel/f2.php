	    ...
	    <div id="header">
	       ...
	       <div id ="banner">
		     <div id="form"><br><br><br><br>
			    <center><div style="color: white; background:#333; opacity: 0.8; width: 75%; float:left;">
	      <h1>Thank you for writing </h1>
	   </div><br><br>
	   <div style="background-color: rgba(255,255,255,0.4); width: 130%; float: left">
	      <h1>we appreciate your feedback and your perspective for our hotel</h1>
	   </div>
